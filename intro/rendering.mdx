...
<CodeSurfer
  ...
  notes=""
  code={require("!raw-loader!./assets/lifecycle.js")}
  lang="jsx"
  dark={true}
/>
...
<List>
  <Appear>
    ...
    <ListItem>
      <InlineCode>static getDerivedStateFromProps(props)</InlineCode>* - return an object to create state based on props
    </ListItem>
    <ListItem>
...
<List>
  <Appear>
    ...
    <ListItem>
      <InlineCode>getSnapshotBeforeUpdate(props, state)</InlineCode>* - capture DOM data before update, to be provided to <InlineCode>componentDidUpdate</InlineCode>
    </ListItem>
    <ListItem>
      <InlineCode>componentDidUpdate(props, state, snapshot)</InlineCode> - it has been updated in the DOM
    </ListItem>
  </Appear>
</List>
